            ...
            <td class="text-center "><img  class="img-fluid card-image"src="img/placeholders/avatars/<?php echo htmlentities($row['image']);?>" alt="avatar" class="img-circle"></td>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    ...
                                                    <a href="staff_delete.php?id=<?php echo htmlentities($row['id']); ?>" data-toggle="tooltip" title="" class="btn btn-xs btn-danger" data-original-title="Delete"><i class="fa fa-times"></i></a>
                                                </div>
                                            </td>
                                        </tr>
