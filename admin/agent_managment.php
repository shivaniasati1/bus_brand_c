...
<div id="page-content">
          ...
          <div class="content-header">
            <div class="header-section">
              <h1>
                <small>WELCOME TO</small> AGENT MANAGMENT
              </h1>
            </div>
          </div>
          <!-- Search Styles Block -->
...
?>     
            ...
            <td class="text-center "><img  class="img-fluid card-image"src="img/placeholders/avatars/<?php echo htmlentities($row['image']);?>" alt="avatar" class="img-circle"></td>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="agent_profile.php?id=<?php echo htmlentities($row['id']); ?>" data-toggle="tooltip" title="" class="btn btn-xs btn-default" data-original-title="view"><i class="fa fa-eye"></i></a>
      ...
      console.log(event);
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="email" id="example-email" name="email" class="form-control" placeholder="Enter Email">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-phone"></i></span>
                                    <input type="password" id="contact" name="password" class="form-control" placeholder="password">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="gi gi-envelope"></i></span>
                                    <input type="password" id="example-email" name="cpassword" class="form-control" placeholder="Confirm password">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="gi gi-user"></i></span>
                                    <input type="text" id="example-email" name="contact" class="form-control" placeholder="contact">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="gi gi-user"></i></span>
                                    <input type="text" id="example-email" name="city" class="form-control" placeholder="city">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="street" name="pan" class="form-control" placeholder="Pan Number">
                                </div>
                            </div>
...
$conn=mysqli_connect("localhost","root","","bus_reservation");
      ...
      if(isset($_POST['submit']))
      {
        ...
        $city=$_POST['city'];
        $pan=$_POST['pan'];
        $sql1="INSERT INTO `agent`(`img`, `name`,`email`,`password`, `cpassword`,`contact`,`agency`, `city`,`pan`) VALUES ('$image','$name','$email','$password','$cpassword','$contact','$agency','$city','$pan')";
